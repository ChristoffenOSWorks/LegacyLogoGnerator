/*
 * The fifth triangle that is an outline.
 *
...
main (int argc, char *argv[])
{
	...
	/* Write output and clean up */
        cairo_surface_write_to_png (surface, "../images/triangle5-outline.png"); //Name the resulting image as triangle5-outline.png
