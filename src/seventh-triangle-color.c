/*
 * The seventh triangle that has color.
 *
...
main (int argc, char *argv[])
{
	...
	cairo_line_to (cr, 252, 326); //Draws a line from Point C back to Point A.
	...
	/* Write output and clean up */
        cairo_surface_write_to_png (surface, "../images/triangle7-color.png"); //Name the resulting image as triangle7-color.png
