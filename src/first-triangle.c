/*
 * The fourth triangle that is an outline.
 *
...
main (int argc, char *argv[])
{
	...
	/* Write output and clean up */
        cairo_surface_write_to_png (surface, "../images/triangle1-outline.png"); //Name the resulting image as triangle1-outline.png
