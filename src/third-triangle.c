/*
 * The third triangle that is an outline.
 *
...
main (int argc, char *argv[])
{
	...
	cairo_line_to (cr, 36.3, 19.0); //Draws a line from Point A to Point B.
	cairo_line_to (cr, 25.0, 12.6); //Draws a line from Point B to Point C.
	cairo_line_to (cr, 30.5, 2.6); //Draws a line from Point C back to Point A.
	...
	/* Write output and clean up */
        cairo_surface_write_to_png (surface, "../images/triangle3-outline.png"); //Name the resulting image as triangle3-outline.png
