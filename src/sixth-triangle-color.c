/*
 * The sixth triangle that has color.
 *
...
main (int argc, char *argv[])
{
	...
	/* Sixth triangle */
	cairo_set_source_rgba (cr, 0.28, 0.42, 0.61, 0.8); //Sets the color of the triangle.
	...
	cairo_set_source_rgba (cr, 0.28, 0.42, 0.61, 0.8); //Sets the color of the triangle (again)
